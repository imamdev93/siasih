            ...
            <div class="ibox ">
                ...
                <div class="ibox-content">
                        ...
                        <div class="col-lg-10">
                            <select name="siswa_id" id="" class="select2_demo_3 form-control">
                                ...
                                @foreach ($siswa as $data)
                                    <option value="{{ old('siswa_id', $nilai->siswa_id) }}" {{ old('nilai_id', $nilai->siswa_id) == $data->id ? 'selected' : '' }}>{{ $data->nama }}</option>
                                @endforeach
                            </select>
                            @error('siswa_id')
                        ...
                        <div class="col-lg-10">
                            <select name="mata_pelajaran_id" id="" class="select2_demo_3 form-control">
                                ...
                                @foreach ($mapel as $data)
                                    <option value="{{ old('mata_pelajaran_id', $nilai->mata_pelajaran_id) }}" {{ old('nilai_id', $nilai->mata_pelajaran_id) == $data->id ? 'selected' : '' }}>{{ $data->nama }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-10">
                            <select name="semester" id="" class="form-control">
                                ...
                                <option value="GANJIL" {{ old('semestes', $nilai->semester) == 'GANJIL' ? 'selected' : '' }}>GANJIL</option>
                                <option value="GENAP" {{  old('semestes', $nilai->semester) == 'GENAP' ? 'selected' : ''  }}>GENAP</option>
                            </select>
                            @error('semester')
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-10">
                            <input type="number" name="nilai" min=0 max=100 class="form-control" value="{{ old('nilai', $nilai->nilai) }}"> 
                            @error('nilai')
