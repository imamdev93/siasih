            ...
            <div class="ibox ">
                ...
                <div class="ibox-content">
                    <div class="form-group row">
                        ...
                        <div class="col-lg-10">
                            <input type="number" min="0" placeholder="NISN" name="nisn" class="form-control" value="{{ old('nisn', $siswa->nisn) }}">
                            @error('nisn')
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-10">
                            <input type="text" placeholder="Nama Siswa" name="nama" class="form-control" value="{{ old('nama', $siswa->nama) }}">
                            @error('nama')
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-10">
                            <input type="text" placeholder="Username" name="username" class="form-control" value="{{ old('username', $siswa->username) }}">
                            @error('username')
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-10">
                            <input type="email" placeholder="Email" name="email" class="form-control" value="{{ old('email', $siswa->email) }}">
                            @error('email')
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-10">
                            <select name="kelas_id" id="" class="form-control">
                                    ...
                                    <option value="{{ $value->id }}" {{ old('kelas_id', $siswa->kelas_id) == $value->id ? 'selected' : ''}}>{{ $value->romawi }} ({{ $value->nama }})</option>
                                @endforeach
                            </select>
                            @error('kelas_id')
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-10">
                            <input type="text" placeholder="Tempat Lahir" name="tempat_lahir" class="form-control" value="{{ old('tempat_lahir', $siswa->tempat_lahir) }}">
                            @error('tempat_lahir')
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-10">
                            <input type="date" placeholder="Tanggal Lahir" name="tanggal_lahir" class="form-control" value="{{ old('tanggal_lahir', $siswa->tanggal_lahir) }}">
                            @error('tanggal_lahir')
