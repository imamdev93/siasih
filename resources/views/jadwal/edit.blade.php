                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-10">
                            <select name="kelas_id" id="" class="select2_demo_3 form-control">
                                    ...
                                    <option value="{{ $value->id }}" {{ old('kelas_id', $jadwal->kelas_id) == $value->id ? 'selected' : ''}}>{{ $value->romawi }} ({{ $value->nama }})</option>
                                @endforeach
                            </select>
                            @error('kelas_id')
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-10">
                            <select name="mata_pelajaran_id" id="" class="select2_demo_3 form-control">
                                    ...
                                    <option value="{{ $value->id }}" {{ old('mata_pelajaran_id', $jadwal->mata_pelajaran_id) == $value->id ? 'selected' : ''}}>{{ $value->nama }}</option>
                                @endforeach
                            </select>
